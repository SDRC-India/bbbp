...
export class AreaFilterPipe implements PipeTransform {
  ...
  transform(areas: any, areaLevelId: number, parentAreaId): IArea[] {

    if(areas != undefined && areas != null && areaLevelId != undefined &&
       areaLevelId != null && parentAreaId != undefined && parentAreaId != null) {
      ...
      switch(areaLevelId){
        ...
        case 3:
          ...
          return districts.filter(area => area.parentAreaId == parentAreaId || parentAreaId == 'allowAll')
        case 4:
